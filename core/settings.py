...
SECRET_KEY = "django-insecure-xup#03vag3x1dtuvnlw16r5kdwjepy577ac53cxi0ia5(5rbm5"
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Pasta separada para collectstatic
